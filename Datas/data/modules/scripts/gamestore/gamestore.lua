...
GameStore.Categories = {
	...
	-- CATEGORIA PRINCIPAL: SPECIAL ITENS
	{
		...
		name = "Special Itens",
		rookgaard = true,
		subclasses = { "Relics", "Rings", "Amulets", "Equipments" },
	},
	...
	state = GameStore.States.STATE_NONE,
	offers = {
	-- Exemplo de item à venda (Sua Relíquia de Teleporte)
			{
				icons = { "Epaminondas_Doll.png" },
				name = "Relic of Recall",
				price = 25,
				itemtype = 9144,
				count = 1,
				description = "<i>An enchanted doll that safely teleports you back to your home town temple instantly.</i>\n\n{character}\n{storeinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Incandescent_Crown.png" },
				name = "Epic Relic",
				price = 25,
				itemtype = 26189,
				count = 1,
