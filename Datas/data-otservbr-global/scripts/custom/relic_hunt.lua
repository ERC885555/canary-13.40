...
local huntCategories = {
    ...
    ["0-50"] = {
        ...
        ["Gloom Caverns"] = Position (32709, 31939, 8),
        ["Shadowthorn"] = Position (33098, 32137, 6),
        ["Mintwalin"] = Position (32493, 32102, 15),
        ["Dark Cathedral"] = Position (32660, 32341, 7),
        ["Dragon Lair (Fibula)"] = Position (32256, 32455, 10),
        ["Dragon Lair (Venore)"] = Position (32789, 32150, 8),
        ["Dragon Lair (Darama)"] = Position(33265, 32274, 8),
        ["Mistrock"] = Position(32637, 31438, 7),
        ["Stonerefiner Cave"] = Position(33038, 32008, 12),
    ...
    ["50-100"] = {
        ...
        ["Lion's Rock"] = Position (33122, 32304, 8),
        ["Bonelord Cave (Liberty Bay)"] = Position (32158, 32782, 7),
        ["Mage Tower (Edron)"] = Position (33312, 31837, 7),
        ["Dragon Lair (Edron)"] = Position (33099, 31699, 7),
        ["Middle Spike"] = Position (32242, 32605, 11),
        ["Grimvale"] = Position (33352, 31670, 7),
        ["Hydra Falls (Port Hope)"] = Position (32979, 32629, 5),
        ["Undead Lair (Edron)"] = Position (33109, 31721, 7),
    ...
    ["200-300"] = {
        ...
        ["Carnivora's Rock"] = Position(32761, 32628, 7),
