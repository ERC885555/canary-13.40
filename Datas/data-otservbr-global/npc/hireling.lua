...
--		},
		["valuables"] = {
			...
			{ itemName = "falcon circlet", clientId = 28714, sell = 1500000 },
			{ itemName = "falcon coif", clientId = 28715, sell = 1500000 },
			{ itemName = "falcon rod", clientId = 28716, sell = 1500000 },
			{ itemName = "falcon wand", clientId = 28717, sell = 1500000 },
			{ itemName = "falcon bow", clientId = 28718, sell = 1500000 },
			{ itemName = "falcon plate", clientId = 28719, sell = 1500000 },
			{ itemName = "falcon greaves", clientId = 28720, sell = 1500000 },
			{ itemName = "falcon shield", clientId = 28721, sell = 1500000 },
			{ itemName = "falcon escutcheon", clientId = 28722, sell = 1500000 },
			{ itemName = "falcon longsword", clientId = 28723, sell = 1500000 },
			{ itemName = "falcon battleaxe", clientId = 28724, sell = 1500000 },
			{ itemName = "falcon mace", clientId = 28725, sell = 1500000 },
			{ itemName = "cobra crossbow", clientId = 30393, sell = 1500000 },
			{ itemName = "cobra boots", clientId = 30394, sell = 1500000 },
			{ itemName = "cobra club", clientId = 30395, sell = 1500000 },
			{ itemName = "cobra axe", clientId = 30396, sell = 1500000 },
			{ itemName = "cobra hood", clientId = 30397, sell = 1500000 },
			{ itemName = "cobra sword", clientId = 30398, sell = 1500000 },
			{ itemName = "cobra wand", clientId = 30399, sell = 1500000 },
			{ itemName = "cobra rod", clientId = 30400, sell = 1500000 },
			{ itemName = "the cobra amulet", clientId = 31631, sell = 1500000 },
			{ itemName = "amulet of theurgy", clientId = 30401, sell = 1000000 },
			{ itemName = "enchanted theurgic amulet", clientId = 30402, sell = 1000000 },
			{ itemName = "enchanted theurgic amulet", clientId = 30403, sell = 1000000 },
			{ itemName = "lion longbow", clientId = 34150, sell = 1500000 },
			{ itemName = "lion rod", clientId = 34151, sell = 1500000 },
			{ itemName = "lion wand", clientId = 34152, sell = 1500000 },
			{ itemName = "lion spellbook", clientId = 34153, sell = 1500000 },
			{ itemName = "lion shield", clientId = 34154, sell = 1500000 },
			{ itemName = "lion longsword", clientId = 34155, sell = 1500000 },
			{ itemName = "lion spangenhelm", clientId = 34156, sell = 1500000 },
			{ itemName = "lion plate", clientId = 34157, sell = 1500000 },
			{ itemName = "lion amulet", clientId = 34158, sell = 1500000 },
			{ itemName = "lion axe", clientId = 34253, sell = 1500000 },
			{ itemName = "lion hammer", clientId = 34254, sell = 1500000 },
			{ itemName = "naga sword", clientId = 39155, sell = 2000000 },
			{ itemName = "naga axe", clientId = 39156, sell = 2000000 },
			{ itemName = "naga club", clientId = 39157, sell = 2000000 },
			{ itemName = "frostflower boots", clientId = 39158, sell = 2000000 },
			{ itemName = "naga crossbow", clientId = 39159, sell = 2000000 },
			{ itemName = "naga quiver", clientId = 39160, sell = 2000000 },
			{ itemName = "feverbloom boots", clientId = 39161, sell = 2000000 },
			{ itemName = "naga wand", clientId = 39162, sell = 2000000 },
			{ itemName = "naga rod", clientId = 39163, sell = 2000000 },
			{ itemName = "dawnfire sherwani", clientId = 39164, sell = 2000000 },
			{ itemName = "midnight tunic", clientId = 39165, sell = 2000000 },
			{ itemName = "dawnfire pantaloons", clientId = 39166, sell = 2000000 },
			{ itemName = "midnight sarong", clientId = 39167, sell = 2000000 },
			...
			{ itemName = "living vine bow", clientId = 29417, sell = 1000000 },
			{ itemName = "living armor", clientId = 29418, sell = 1000000 },
			{ itemName = "resizer", clientId = 29419, sell = 1000000 },
			{ itemName = "shoulder plate", clientId = 29420, sell = 1000000 },
			{ itemName = "summerblade", clientId = 29421, sell = 1000000 },
			{ itemName = "winterblade", clientId = 29422, sell = 1000000 },
			{ itemName = "dream shroud", clientId = 29423, sell = 1000000 },
			{ itemName = "pair of dreamwalkers", clientId = 29424, sell = 1000000 },
			{ itemName = "energized limb", clientId = 29425, sell = 1000000 },
			{ itemName = "brain in a jar", clientId = 29426, sell = 1000000 },
			{ itemName = "dark whispers", clientId = 29427, sell = 1000000 },
			{ itemName = "sleep shawl", clientId = 29428, sell = 1000000 },
			{ itemName = "pendulet", clientId = 29429, sell = 1000000 },
			{ itemName = "ectoplasmic shield", clientId = 29430, sell = 1000000 },
			{ itemName = "spirit guide", clientId = 29431, sell = 1000000 },
			{ itemName = "phantasmal axe", clientId = 32616, sell = 1000000 },
			{ itemName = "fabulous legs", clientId = 32617, sell = 1000000 },
			{ itemName = "soulful legs", clientId = 32618, sell = 1000000 },
			{ itemName = "pair of nightmare boots", clientId = 32619, sell = 1000000 },
			{ itemName = "enchanted ring of souls", clientId = 32621, sell = 4000000 },
			{ itemName = "ghost chestplate", clientId = 32628, sell = 1000000 },
			{ itemName = "ring of souls", clientId = 32636, sell = 4000000 },
			{ itemName = "soulcutter", clientId = 34082, sell = 4000000 },
			{ itemName = "soulshredder", clientId = 34083, sell = 4000000 },
			{ itemName = "soulbiter", clientId = 34084, sell = 4000000 },
			{ itemName = "souleater", clientId = 34085, sell = 4000000 },
			{ itemName = "soulcrusher", clientId = 34086, sell = 4000000 },
			{ itemName = "soulmaimer", clientId = 34087, sell = 4000000 },
			{ itemName = "soulbleeder", clientId = 34088, sell = 4000000 },
			{ itemName = "soulpiercer", clientId = 34089, sell = 4000000 },
			{ itemName = "soultainter", clientId = 34090, sell = 4000000 },
			{ itemName = "soulhexer", clientId = 34091, sell = 4000000 },
			{ itemName = "soulshanks", clientId = 34092, sell = 4000000 },
			{ itemName = "soulstrider", clientId = 34093, sell = 4000000 },
			{ itemName = "soulshell", clientId = 34094, sell = 4000000 },
			{ itemName = "soulmantle", clientId = 34095, sell = 4000000 },
			{ itemName = "soulshroud", clientId = 34096, sell = 4000000 },
			{ itemName = "pair of soulwalkers", clientId = 34097, sell = 4000000 },
			{ itemName = "pair of soulstalkers", clientId = 34098, sell = 4000000 },
			{ itemName = "soulbastion", clientId = 34099, sell = 4000000 },
			{ itemName = "sanguine blade", clientId = 43864, sell = 8000000 },
			{ itemName = "grand sanguine blade", clientId = 43865, sell = 10000000 },
			{ itemName = "sanguine cudgel", clientId = 43866, sell = 8000000 },
			{ itemName = "grand sanguine cudgel", clientId = 43867, sell = 10000000 },
			{ itemName = "sanguine hatchet", clientId = 43868, sell = 8000000 },
			{ itemName = "grand sanguine hatchet", clientId = 43869, sell = 10000000 },
			{ itemName = "sanguine razor", clientId = 43870, sell = 8000000 },
			{ itemName = "grand sanguine razor", clientId = 43871, sell = 10000000 },
			{ itemName = "sanguine bludgeon", clientId = 43872, sell = 8000000 },
			{ itemName = "grand sanguine bludgeon", clientId = 43873, sell = 10000000 },
			{ itemName = "sanguine battleaxe", clientId = 43874, sell = 8000000 },
			{ itemName = "grand sanguine battleaxe", clientId = 43875, sell = 10000000 },
			{ itemName = "sanguine legs", clientId = 43876, sell = 8000000 },
			{ itemName = "sanguine bow", clientId = 43877, sell = 8000000 },
			{ itemName = "grand sanguine bow", clientId = 43878, sell = 10000000 },
			{ itemName = "sanguine crossbow", clientId = 43879, sell = 8000000 },
			{ itemName = "grand sanguine crossbow", clientId = 43880, sell = 10000000 },
			{ itemName = "sanguine greaves", clientId = 43881, sell = 8000000 },
			{ itemName = "sanguine coil", clientId = 43882, sell = 8000000 },
			{ itemName = "grand sanguine coil", clientId = 43883, sell = 10000000 },
			{ itemName = "sanguine boots", clientId = 43884, sell = 8000000 },
			{ itemName = "sanguine rod", clientId = 43885, sell = 8000000 },
			{ itemName = "grand sanguine rod", clientId = 43886, sell = 10000000 },
			{ itemName = "sanguine galoshes", clientId = 43887, sell = 8000000 },
			{ itemName = "stoic iks cuirass", clientId = 44619, sell = 4000000 },
			{ itemName = "stoic iks chestplate", clientId = 44620, sell = 4000000 },
			{ itemName = "stoic iks casque", clientId = 44636, sell = 4000000 },
			{ itemName = "stoic iks headpiece", clientId = 44637, sell = 4000000 },
			{ itemName = "stoic iks culet", clientId = 44642, sell = 4000000 },
			{ itemName = "stoic iks faulds", clientId = 44643, sell = 4000000 },
			{ itemName = "stoic iks boots", clientId = 44648, sell = 4000000 },
			{ itemName = "stoic iks sandals", clientId = 44649, sell = 4000000 },
			{ itemName = "bear skin", clientId = 31578, sell = 2000000 },
			{ itemName = "terra helmet", clientId = 31577, sell = 2000000 },
			{ itemName = "embrace of nature", clientId = 31579, sell = 2000000 },
			{ itemName = "mortal mace", clientId = 31580, sell = 2000000 },
			{ itemName = "bow of cataclysm", clientId = 31581, sell = 2000000 },
			{ itemName = "galea mortis", clientId = 31582, sell = 2000000 },
			{ itemName = "toga mortis", clientId = 31583, sell = 2000000 },
			{ itemName = "tagrald blade", clientId = 31614, sell = 2000000 },
			{ itemName = "enchanted blister ring", clientId = 31616, sell = 2000000 },
			{ itemName = "winged boots", clientId = 31617, sell = 2000000 },
			{ itemName = "blister ring", clientId = 31621, sell = 2000000 },
			{ itemName = "antler-horn helmet", clientId = 40588, sell = 2500000 },
			{ itemName = "stitched mutant hide legs", clientId = 40589, sell = 2500000 },
			{ itemName = "mutated skin legs", clientId = 40590, sell = 2500000 },
			{ itemName = "mutated skin armor", clientId = 40591, sell = 2500000 },
			{ itemName = "alchemist's boots", clientId = 40592, sell = 2500000 },
			{ itemName = "mutant bone boots", clientId = 40593, sell = 2500000 },
			{ itemName = "alchemist's notepad", clientId = 40594, sell = 2500000 },
			{ itemName = "mutant bone kilt", clientId = 40595, sell = 2500000 },
			{ itemName = "spiritthorn armor", clientId = 39147, sell = 5000000 },
			{ itemName = "spiritthorn helmet", clientId = 39148, sell = 5000000 },
			{ itemName = "alicorn headguard", clientId = 39149, sell = 5000000 },
			...
			{ itemName = "the calamity", clientId = 8104, sell = 1000000 },
			{ itemName = "wand of dimensions", clientId = 12603, sell = 1000000 },
			{ itemName = "jungle flail", clientId = 35514, sell = 1000000 },
			{ itemName = "throwing axe", clientId = 35515, sell = 1000000 },
			{ itemName = "exotic legs", clientId = 35516, sell = 1000000 },
			{ itemName = "bast legs", clientId = 35517, sell = 1000000 },
			{ itemName = "jungle bow", clientId = 35518, sell = 1000000 },
			{ itemName = "makeshift boots", clientId = 35519, sell = 1000000 },
			{ itemName = "make-do boots", clientId = 35520, sell = 1000000 },
			{ itemName = "jungle rod", clientId = 35521, sell = 1000000 },
			{ itemName = "jungle wand", clientId = 35522, sell = 1000000 },
			{ itemName = "exotic amulet", clientId = 35523, sell = 1000000 },
		...
		elseif npcHandler:getTopic(playerId) == TOPIC.SERVICES then
			...
			elseif MsgContains(message, "goods") then
				...
				if not hireling:hasSkill(HIRELING_SKILLS.TRADER[2]) then
					...
					string = "I sell a selection of {various} items, {exercise weapons}, {equipment}, " .. "{distance} weapons, {wands} and {rods}, {potions}, {runes}, " .. "{supplies}, {tools}, {valuables} and {postal} goods. Just ask!"
				end
