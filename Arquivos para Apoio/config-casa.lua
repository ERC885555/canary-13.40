...
maxPlayers = 0
serverName = "Ironman Server"                    -- Aca para cambiar el nombre del OT
serverMotd = "Welcome to Ironman Server!"     -- ""Aca para cambiar el nombre del"" OT
...
augmentIncreasedDamagePercent = 25
augmentPowerfulImpactPercent = 25
augmentStrongImpactPercent = 25
...
preyBonusTime = 2 * 240 * 240
preyFreeRerollTime = 10 * 10 * 10
...
taskHuntingRerollPricePerLevel = 10
taskHuntingSelectListPrice = 1
taskHuntingBonusRerollPrice = 1
taskHuntingFreeRerollTime = 10 * 10 * 10
...
forgeConvergenceTransferCost = 1
...
forgeFiendishLimit = 200
forgeFiendishIntervalType = "hour"
forgeFiendishIntervalTime = "1"

ruseChanceFormulaA = 0.4307576
ruseChanceFormulaB = 0.440697
ruseChanceFormulaC = 0.426

onslaughtChanceFormulaA = 0.45
onslaughtChanceFormulaB = 0.4
onslaughtChanceFormulaC = 0.45

momentumChanceFormulaA = 0.45
momentumChanceFormulaB = 1.9
momentumChanceFormulaC = 0.45

transcendanceChanceFormulaA = 0.4127
transcendanceChanceFormulaB = 0.4070
transcendanceChanceFormulaC = 0.4073
...
-- Loyalty system
loyaltyEnabled = true
loyaltyPointsPerCreationDay = 10
...
wheelAtelierRevealRegularCost = 100
wheelAtelierRevealGreaterCost = 600
...
-- MySQL
mysqlHost = "127.0.0.1"
mysqlUser = "admin"          -- Reemplaza "root" por el usuario que coloste en PHPMyAdmin.
mysqlPass = "Erocosta007"              -- Coloca la contraseña que colocaste en PHPMyAdmin.
mysqlDatabase = "video"    -- Nombre de la Base de Datos que importaste.
mysqlPort = 3306
mysqlSock = ""
passwordType = "sha1"
...
rateKillingInTheNameOfPoints = 10
...
bossDefaultTimeToFightAgain = 2 * 60 * 60 -- 2 hours
bossDefaultTimeToDefeat = 60 * 60 -- 60 minutes
...
ownerName = "Emanuel Costa"
ownerEmail = "singleplayer11131@gmail.com"
